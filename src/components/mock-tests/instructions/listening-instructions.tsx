        ...
        <div className="w-full min-h-screen flex items-center justify-center p-6">
            <Card className="w-full max-w-2xl rounded-2xl border shadow-2xl">
                <CardContent className="p-10 space-y-6 text-center ">
                    ...
                    <p className="text-lg leading-relaxed text-slate-900 dark:text-gray-300">
                    ...
                    <p className="text-lg leading-relaxed text-slate-700 dark:text-gray-200">
                    ...
                    <p className="text-lg leading-relaxed text-slate-600 dark:text-gray-100">

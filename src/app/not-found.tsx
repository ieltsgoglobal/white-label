    ...
    return (
        <ContentLayout title="IELTS GO GLOBAL">
            ...
            <PlaceholderContent>
                <div className="container px-4 md:px-6 py-12 relative">
                    <div className="text-center max-w-3xl mx-auto mb-12" >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="https://ieltsgoglobal.com">
                ...
                <div className="w-full flex items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
                    <div className="w-full md:w-2/3 lg:w-1/2 h-full flex lg:items-end justify-center p-4">

        ...
        <div className="w-full min-h-screen bg-gradient-to-br from-slate-100 via-indigo-50/50 to-purple-50/50 flex justify-center items-center p-6">
            <div className="flex flex-col items-center justify-center space-y-8 w-full">
                ...
                <div className="max-w-6xl mx-auto">
                    <Card
                        className={`overflow-hidden border-0 shadow-[0_20px_40px_-8px_rgba(0,0,0,0.3)] bg-white backdrop-blur-xl relative group ${isMobile ? "aspect-[16/10] h-[300px]" : "aspect-[16/9] h-[500px]"
                            }`}

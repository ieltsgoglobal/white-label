export type B2CPlanId = "b2c-7d" | "b2c-14d" | "b2c-21d" | "b2c-30d" | "b2c-test-7d";
...
const B2C_PLANS: Record<B2CPlanId, B2CPlan> = {
    "b2c-7d": { id: "b2c-7d", title: "7-Day Access", label: "1-Week Validity", durationDays: 7, priceInr: 299, type: "B2C_V1_FIXED", isActive: true },
    "b2c-14d": { id: "b2c-14d", title: "14-Day Access", label: "2-Week Validity", durationDays: 14, priceInr: 499, type: "B2C_V1_FIXED", isActive: true },
    "b2c-21d": { id: "b2c-21d", title: "21-Day Access", label: "3-Week Validity", durationDays: 21, priceInr: 649, type: "B2C_V1_FIXED", isActive: true },
    "b2c-30d": { id: "b2c-30d", title: "30-Day Access", label: "4-Week Validity", durationDays: 30, priceInr: 799, type: "B2C_V1_FIXED", isActive: true },

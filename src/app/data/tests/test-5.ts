// https://www.youtube.com/watch?v=TjvBclgudjs&list=PLuQGWPGBwOIcO7maxLbfE9xTp462gz-hc&index=36
export const listening_section_1 = {
    audio: "https://www.dropbox.com/scl/fi/zqfsxd2e36mtbiyyk2pg0/part1.mp4?rlkey=4r24k2y8hsgpadz7kptce61r2&st=mj4q28xt&raw=1",
    questions: [
        {
            ...
            questions: [
                {
                    id: 1,
                    question: "The customer’s coach departs at",
                    options: ["1.00 p.m.", "2.00 p.m.", "3.00 p.m."]
                },
                {
                    id: 2,
                    question: "The customer wants",
                    options: ["a single ticket.", "a return ticket.", "an open return ticket."]
                },
                {
                    id: 3,
                    question: "The customer is going to London",
                    options: ["to attend a family party.", "to see his daughter.", "for a meeting."]
                }
            ]
        },
        {
                ...
                sections: [
                    {
                        ...
                        fields: [
                            {
                                label: "Name:",
                                content: "Mathew (4) _______",
                                id: 4
                            },
                            {
                                label: "Address:",
                                content: "34 (5) _______",
                                id: 5
                            },
                            {
                                label: "Telephone:",
                                content: "01732 (6) _______",
                                id: 6
                            },
                            {
                                label: "Email:",
                                content: "matt (7) _______ @yahoo.co.uk",
                                id: 7
                            }
                        ]
                    }
        ...
        },
        {
            ...
            questions: [
                {
                    id: 8,
                    question: "Apart from hand luggage, travellers",
                    options: [
                ...
                {
                    id: 10,
                    question: "The customer decides to pay",
                    options: [
                        "by debit card.",
                        "in cash.",
                        "by cheque."
...
export const listening_section_2 = {
    // 7 minute audio   
    audio: "https://www.dropbox.com/scl/fi/dhsacfgo6q5sylxyqacgp/part2.mp4?rlkey=ndr8s6rip2k84mc7h3d714xz9&st=vdqmm63a&raw=1",
    questions: [
        {
            ...
            questions: [
                {
                    id: [11, 12, 13],
                    question: "Which THREE changes have been made to the library over the summer?",
                    options: [
                        "a new roof",
                        "new computers",
                        "new shelf units",
        ...
        },
        {
            ...
            questions: [
                {
                    id: 17,
                    question: "The library needs a teacher for the Computer Club because",
                    options: [
                ...
                {
                    id: 18,
                    question: "Who does the library want older people to talk to about the past?",
                    options: [
                        "teachers",
                        "young children",
                        "teenagers"
        ...
        },
        {
            ...
            questions: [
                {
                    id: [19, 20],
                    question: "In addition to books, which TWO services does the mobile library offer?",
                    options: [
                        "computer lessons",
...
export const listening_section_3 = {
    audio: "https://www.dropbox.com/scl/fi/1ml7yjomkg6ii4g5y4dd3/part3.mp4?rlkey=eg1u40p3tqpkp85rwcnba0isj&st=iebpgazq&raw=1",
    questions: [
        {
            ...
            questions: [
                {
                    id: 21,
                    sentence: "The best days for engineering students are (21) _____."
                },
                {
                    id: 22,
                    sentence: "Students can get useful suggestions about (22) _____."
                },
                {
                    id: 23,
                    sentence: "Use the internet to look at (23) _____ before the event."
                }
            ]
        },
        {
            ...
            questions: [
                ...
                {
                    id: 25,
                    question: "The tutor thinks Fergus should",
                    options: [
                ...
                {
                    id: 27,
                    question: "The tutor suggests that Fergus",
                    options: [
        ...
        },
        {
            ...
            questions: [
                {
                    id: [28, 29, 30],
                    question: "Why do the tutor and Fergus think it is useful to attend a jobs fair?",
                    options: [
                        "to get a job",
                        "to find out what employers want from you",
                        "to give employers your contact details",
                        "to discover which are the key companies to work for",
...
export const listening_section_4 = {
    audio: "https://www.dropbox.com/scl/fi/13jso0a1my1myof9s9rk9/part4.mp4?rlkey=5kvwffoskcvjnj8js0jhbj5ba&st=pnrco1u8&raw=1",
    questions: [
        {
            questionType: "multiple-choice-single",
            questions: [
                ...
                {
                    id: 32,
                    question: "The island of Vanuatu",
                    options: [
                ...
                {
                    id: 33,
                    question: "Archaeologists wanted to discover",
                    options: [
                        "what resources were available on the island.",
                        "if the settlers could rely entirely on local food sources.",
                        "the extent to which the settlers ate food they had bought with them."
                    ]
                }
            ]
        },
        {
            ...
            questions: [
                {
                    id: 34,
                    sentence: "Bones provide a dietary (34) _____ of the things people ate."
                },
                {
                    id: 35,
                    sentence: "Different ratios of carbon and sulphur are found in organisms depending on whether they come from the (35) _____."
                },
                {
                    id: 36,
                    sentence: "Archaeologists analysed modern and (36) _____ food sources for chemical elements."
                },
                {
                    id: 37,
                    sentence: "The settlers ate wild creatures as well as (37) _____."
                }
            ]
        },
        {
            ...
            questions: [
                {
                    id: [38, 39],
                    question: "An analysis of the bones of men and women suggest that",
                    options: [
        ...
        },
        {
            ...
            questions: [
                {
                    id: 40,
                    question: "The bones of pigs and chickens indicate that these animals",
                    options: [
                        "only ate food provided by the settlers.",
                        "were a main source of food for the settlers.",
                        "probably did not consume the settler’s limited food supplies."
                    ]
                }
            ]
        }
...
Although predominantly a men’s sport because of its ruthless nature, women are not left behind. Women’s boxing has been getting increasingly more attention over time, with the first women’s boxing championship taking place in 1974. Women’s amateur boxing championship was first introduced at the 1996 Summer Olympics in Atlanta, Georgia. Since then, it has become a regular part of the Olympic program, where women compete in three weight classes. It was officially recognized as an Olympic sport in 2012. Women’s professional boxing has also grown in popularity in recent years, with many talented female boxers competing at the highest levels of the sport. Some of the most successful female boxers include Mary Kom of India, who is a five-time World Amateur Boxing champion and the only woman boxer to have won a medal in each one of the six world championships, and Claressa Shields, who is a three-time Olympic gold medalist and the most successful American amateur boxer of all time.
    `
    },
    questions: [
        {
            ...
            question: {
                headings: [
                    { number: "i", text: "Punching and Kicking" },
                    { number: "ii", text: "Across the Atlantic" },
                    { number: "iii", text: "Blessed by Heavens" },
                    { number: "iv", text: "Outnumbered, but not Outperformed" },
                    { number: "v", text: "Evolution and Recognition" },
                    { number: "vi", text: "Keeping it Civilised" },
                    { number: "vii", text: "The First Blow" },
                    { number: "viii", text: "Gender Inequality" }
                ],
                id: [1, 2, 3, 4, 5]
            }
        },
        {
            ...
            questions: [
                {
                    id: 6,
                    statement: "It is unknown what country boxing came from"
                },
                {
                    id: 7,
                    statement: "Greeks were the first to come up with rules for boxing matches"
                },
                {
                    id: 8,
                    statement: "No visual evidence of ancient boxing has survived"
                },
                {
                    id: 9,
                    statement: "A certain deity was associated with the sports of boxing"
                }
            ]
        },
        {
...
export const reading_section_2 = {
    reading_passage: {
        title: "The Antarctic",
        subtitle: "A deep dive into what remains to be the most mysterious continent.",
        passage: `
    ...
    questions: [
        {
            ...
            questions: [
                {
                    id: 15,
                    statement: "Antarctica is larger in size than the Antarctic."
                },
                {
                    id: 16,
                    statement: "The name of the northernmost continent originates from a celestial body."
                },
                {
                    id: 17,
                    statement: "No bears can be found in the Antarctic."
                },
                {
                    id: 18,
                    statement: "The Antarctic gets colder during winter months."
                },
                {
                    id: 19,
                    statement: "An unusual weather condition has led to accumulation of landmass."
                },
                {
                    id: 20,
                    statement: "No aboriginal population exists in the Antarctic."
                }
            ]
        },
        {
...
export const reading_section_3 = {
    reading_passage: {
        title: "Automobile engines of yesterday, today and tomorrow",
        subtitle: "",
        passage: `
...
This may come as a surprise to many, but the electric engine is not a novel idea. The first electricity-propelled vehicles were made as early as 1830, effectively predating cars equipped with the more conventional fuel engines by more than 50 years. By the beginning of the twentieth century, however, the electric motor had started lagging behind the petrol engine for a number of reasons, primarily due to their relatively high costs and unimpressive top speed. The internal combustion engine, on the other hand, was undergoing rapid development. At the time, petrol proved to be a more energy-efficient fuel, and its engine’s output was easy to increase through the combined displacement volume of all cylinders. Simply put, a bigger engine normally results in a more powerful car, something that is more difficult to achieve with the electric motor. These, among other factors, made it a more favourable choice for the car manufacturers of the past.
The energy crises of the 1970s and 1980s brought about renewed interest in electric cars as a way to become less dependent on the price volatility of hydrocarbon fuels. Several major car companies developed models that were either fully electric or using so-called hybrid systems where petrol and electric engines would work to complement one another. The latter would mostly be used for stop-and-go traffic, common during rush hours and city traffic in general. All in all, public reception of this innovation was lukewarm at best because by the time these new models went om sale the oil prices had already stabilised, which, for the time being, mostly defeated the purpose of buying an electric vehicle.
    ...
    questions: [
                ...
                rows: [
                    {
                        cells: [
                            { content: "Electric" },
                            { content: "• fewer (29)_______ parts\n• lower (30)_______ pollution\n• decreased environmental impact", id: [29, 30] },
                            { content: "• underdeveloped, scarce (31)_______\n• lack of qualified mechanics\n• questionable (32)_______ longevity", id: [31, 32] },
                            { content: "• actively promoted by the government\n• developing rapidly" }
                        ]
                    },
                    {
                        cells: [
                            { content: "Petrol" },
                            { content: "• parts and (33)_______ are available everywhere\n• simple enough to be fixed yourself", id: 33 },
                            { content: "• limited (34)_______ reserves\n• high levels of pollution", id: 34 },
                            { content: "• can work in conjunction with (35)_______", id: 35 }
                        ]
                    }
                ]
            }
        },
        {
            ...
            questions: [
                {
                    id: 36,
                    question: "Why is the government reluctant to expand the electric engine charging grid?",
                    options: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        "B enjoyed a prolonged period of popularity in the past.",
                ...
                {
                    id: 38,
                    question: "How do electric cars manage to have a lower environmental impact?",
                    options: [
...
// https://practicepteonline.com/ielts-writing-test-101/
// task 2 from test glider mock test 1
export const writingTasks = [
    {
        ...
        image_url: "https://www.dropbox.com/scl/fi/ynhtqcwinicu3xop960zo/test5-task1.png?rlkey=jozn2pw9pkwrawj2n1nyw5cre&st=i37qln1s&raw=1"
    },
    {
        id: 2,
...
// https://www.ieltsbuddy.com/ielts-sample-speaking-test.html
export const speaking_transcripts = [
    {
        part: 1,
        questions: [
            { id: 1, transcript: "Now, in this part of the test, I will ask you some questions about yourself. After each question, there will be a beep sound. You will have 20 seconds to speak after the beep. So, Lets talk about shopping. Do you enjoy shopping?", audioUrl: "https://www.dropbox.com/scl/fi/26cx9od6wmoa4v6ry5aja/part1_q1.mp3?rlkey=fezg1ewfenktulgkmc0bd9s2t&st=tsa3cgir&raw=1" },
            { id: 2, transcript: "How often do you go shopping, and what do you buy!?", audioUrl: "https://www.dropbox.com/scl/fi/ogrhdkwinflmnugyxckkm/part1_q2.mp3?rlkey=6hwjgjf0jf4zehfsk5c9lsp4a&st=j2rep8fu&raw=1" },
            { id: 3, transcript: "Do you prefer to go shopping alone or with other people? Why?", audioUrl: "https://www.dropbox.com/scl/fi/8f01tbpui1w3kifkostjy/part1_q3.mp3?rlkey=851r952ssukb8nmvkp9qjfmf3&st=pag6tzuf&raw=1" },
            { id: 4, transcript: "I’d like to move on and ask you some questions about food. What is you favourite food? Why?", audioUrl: "https://www.dropbox.com/scl/fi/8sohsmalvc5gw77bhou3p/part1_q4.mp3?rlkey=8rkvcewsjs969pu1w02fuosjt&st=2tdrg4bs&raw=1" },
            { id: 5, transcript: "What kind of restaurants do you like to eat out at?", audioUrl: "https://www.dropbox.com/scl/fi/4xpqk5q0iic34tbl1cgg8/part1_q5.mp3?rlkey=b9mduwbz5sj8a1wlebkn0jf6w&st=o6damsli&raw=1" },
            { id: 6, transcript: "What kinds of food would be included in your perfect meal, and who would you like to share it with?", audioUrl: "https://www.dropbox.com/scl/fi/lklo2w7ag9zqteon3p7nr/part1_q6.mp3?rlkey=e864gtabcf13i5zmz1s79gedp&st=1bxgaa8u&raw=1" },
            { id: 7, transcript: "I'd like to talk now about your hobbies. Tell me about any hobbies you have.", audioUrl: "https://www.dropbox.com/scl/fi/725dua4iu7tu990hfnwfb/part1_q7.mp3?rlkey=yspn2uw4wpq4k3ipya164tyd8&st=bwy42gha&raw=1" },
            { id: 8, transcript: "Are there any hobbies you would like to have in the future?", audioUrl: "https://www.dropbox.com/scl/fi/etstkj8gpj5iot2dmv3q5/part1_q8.mp3?rlkey=5sed77d6ty8dmaix9jr4lev7w&st=kkpnfgyp&raw=1" },
            { id: 9, transcript: "Do you think hobbies should be relaxing or should they be exciting? Why?", audioUrl: "https://www.dropbox.com/scl/fi/ku46isqoygnezxhd6ayez/part1_q9.mp3?rlkey=nilr556z20x9z796pvckve1f2&st=kfg9yvbg&raw=1" },
        ]
    },
    {
        part: 2,
